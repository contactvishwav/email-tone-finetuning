...
ADAPTER_PATH = "gemma3-270m-instruction-lora-adapter"
...
ds = load_dataset("json", data_files="instruction_emails.jsonl", split="train")
...
args = SFTConfig(
    output_dir="gemma3-270m-instruction-lora",
    per_device_train_batch_size=1,
    gradient_accumulation_steps=8,
    dataloader_pin_memory=False,
    learning_rate=5e-5,
    num_train_epochs=25,              # more epochs: hardest task, most instruction variety
    weight_decay=0.01,
...
print(f"Starting Instruction Model training on {device.upper()}...")
trainer.train()
